...
var Player_tex1 = preload("res://Graphics/Player/Agent przód.png")
var Player_tex2 = preload("res://Graphics/Player/Agent tył.png")
var Player_tex3 = preload("res://Graphics/Player/Agent bok.png")
